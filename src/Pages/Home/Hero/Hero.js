...
const Hero = () => {
  ...
  return (
    <section className='home' id='home'>
            ...
            <button class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center bg-gray-200 text-green-500 border border-gray-300 rounded-lg  text-gray-950 ">
               Get Started
